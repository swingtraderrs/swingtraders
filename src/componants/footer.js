...
const Footer = () => {
  ...
  return (
    <footer className="footer">
      <div className="">
         <div className="container-fluid bg-black py-5 footer-background">
         <div className="container">
          <div className="row text-white lh-lg">
            ...
            <div className="col-md-3 col-sm-6 text-center">
              ...
              <ul className="list-unstyled">
                <li><Link to="/basiccourse" className="text-white text-decoration-none">Basic Course</Link></li>
                <li ><Link to="/advancecourse" className="text-white text-decoration-none">Advance Course</Link></li>
                <li ><Link to="/niletcourse" className="text-white text-decoration-none">Intermediate Courses</Link></li>
                <li ><Link to="/niletcourse" className="text-white text-decoration-none">All Courses</Link></li>
              </ul>
            </div>
            <div className="col-md-3 col-sm-6 text-center">
              <h4>Contact Us</h4>
